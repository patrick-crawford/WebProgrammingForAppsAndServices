...
1. clone your forked repo to your local machine, `git clone https://github.com/{your username}/WebProgrammingForAppsAndServices`
...
8. Save image to the `/static/img` folder in the WebProgrammingForAppsAndServices repo
