...
For this first test, we must ensure that a link to ["https://vercel.com"](https://vercel.com) is rendered within the within the "main" element (section). We know this to be true by visually expecting the output, but how can we test this programmatically?
