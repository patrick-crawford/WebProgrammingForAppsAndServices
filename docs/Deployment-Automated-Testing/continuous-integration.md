...
- **- name:** Checkout code, **uses:** actions/checkout@v3: This defines the first step of our job, named "Checkout code". It uses the ["Checkout V3" Action](https://github.com/actions/checkout), which: "checks-out your repository under $GITHUB_WORKSPACE, so your workflow can access it."
